...
/* loaded from: KitsX-1.0.3-all.jar:com/mojang/brigadier/arguments/StringArgumentType.class */
public class StringArgumentType implements ArgumentType<String> {
    ...
    /* loaded from: KitsX-1.0.3-all.jar:com/mojang/brigadier/arguments/StringArgumentType$StringType.class */
